...
gunicorn budget_proj.wsgi:application -b :8000 --keep-alive 60 --workers 5 --worker-class 'gevent' --log-file - # gevent used to address ELB/gunicorn issue here https://github.com/benoitc/gunicorn/issues/1194
